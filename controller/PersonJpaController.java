...
public class PersonJpaController implements Serializable {
    ...
    public Person findDuplicate(Person p) {
    	...
    	List<Person> res = em.createNamedQuery("Person.findDuplicate").setParameter("firstname",
        p.getFamilyname()).setParameter("familyname",
        p.getFamilyname()).setParameter("dateofbirth", p.getDateofbirth()).getResultList(); 			// Gives a list of person
