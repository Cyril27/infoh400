...
import ulb.lisa.infoh400.labs2022.view.HL7Services;
...
public class HL7SendWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hl7PortTextField.setText("65432");
    ...
    private void hl7SendButtonActionPerformed(java.awt.event.ActionEvent evt) {                                              
        String host = hl7HostTextField.getText();
        int port = Integer.valueOf(hl7PortTextField.getText());
        
        HL7Services hl7 = new HL7Services();
        hl7.send_ADT_A01(hl7.create_ADT_A01(patient), host, port); 				// send an ADT-A01 message to the test listening server
        																		// defined by the other main window
    }                                             
