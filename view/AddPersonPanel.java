...
public class AddPersonPanel extends javax.swing.JPanel {
    ...
    public void setPerson(Person person){  									// mets les infos de la personnes de base
        this.person = person;
    ...
    public Person getPerson(){
        if( person == null ){
            person = new Person();											// si pas de personne on en crée une
        }
        
        person.setFamilyname(familynameTextField.getText());				// update les infos de la personne
